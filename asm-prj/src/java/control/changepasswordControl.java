...
public class changepasswordControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (curPass.equalsIgnoreCase(a.getPassword())){
            
            if (newPass.equalsIgnoreCase(reNewPass)){
               dao.changePass(a.getUsername(), newPass);
               request.getRequestDispatcher("login.jsp").forward(request, response);
                
            }
            else{
                // error
                request.setAttribute("errorChange", "Re-Pass not Same");
            ...
            // error
            request.setAttribute("errorChange", "Current Pass not Correct");
            request.getRequestDispatcher("changepassword.jsp").forward(request, response);

 ...
 * @author trant
 */
@WebServlet(name="subcategoryControl", urlPatterns={"/subcategory"})
public class subcategoryControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Product> listBySC = dao.getAllProductOfSubCategory(scid);
        ...
        request.setAttribute("listProductOfCategory", listBySC);
